---
id: curriculum-adoption-checklist
title: Curriculum Adoption Checklist
...
| Resource | What it is |
|---|---|
| [Implementation Pathways](implementation-pathways.md) | Detailed guidance for different settings |
| [Ecosystem Overview](ecosystem-overview.md) | How the nine curricula connect |
| [Privacy and Student Data](privacy-and-student-data.md) | No data collected — explained |
