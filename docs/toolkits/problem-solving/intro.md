...
sidebar_label: Toolkit Overview
slug: /toolkits/problem-solving
---
...
1. Notice what is happening inside me.
2. Communicate clearly with other people.
3. Define the problem and try a useful next step.

You can explore the first two here: the [Coping Skills Toolkit](../coping-skills/intro.md) and the [Communication Toolkit](../communication/intro.md).
...
1. [What Problem Are We Solving?](./lesson-01-what-problem-are-we-solving.md) — name the real problem, not just the complaint
2. [Facts, Guesses, and Missing Information](./lesson-02-facts-guesses-missing-information.md) — sort what you know from what you think
3. [Break It Into Smaller Parts](./lesson-03-break-it-into-parts.md) — make a big problem smaller
4. [Brainstorm More Than One Option](./lesson-04-brainstorm-options.md) — give your brain more choices
5. [Try One Safe Step](./lesson-05-try-one-safe-step.md) — test a small, safe idea
6. [Observe What Happened](./lesson-06-observe-what-happened.md) — treat results as information
7. [Adjust and Try Again](./lesson-07-adjust-and-try-again.md) — use what you learned for the next try
8. [Build Your Problem Solving Checklist](./lesson-08-build-your-problem-solving-checklist.md) — make the loop easy to find

Then keep the [Printable Problem Solving Cards](./printables.md) handy for quick reference.
